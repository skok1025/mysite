...
<html>
<head>
<c:if test='${param.updatesuccess == "success" }'>
			...
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.request.contextPath }/admin/main/update" enctype="multipart/form-data">
						...
						<img id="profile" src="${pageContext.request.contextPath }/saves/${siteVo.profile}">
						<input type="file" name="attach" value="file:/mysite-uploads/${siteVo.profile }" >
